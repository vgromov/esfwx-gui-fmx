...
)
{
  ...
  {
    if( s_inst->m_onNotify )
      s_inst->m_onNotify(nullptr);
...
static bool childrenIterateInternal(TFmxObject* obj, EsUtilities::EsFmxChildrenIteratorFn fn)
{
  ES_ASSERT( obj );
  ES_ASSERT( fn );

  for( int idx = 0; idx < obj->ChildrenCount; ++idx )
  {
    TFmxObject* child = obj->Children->Items[idx];
    ES_ASSERT(child);

    if(
      !fn( *child ) ||
      !childrenIterateInternal(
        child,
        fn
      )
    )
...
void EsUtilities::childrenIterate(TFmxObject* obj, EsUtilities::EsFmxChildrenIteratorFn fn)
{
  if( !obj || !fn )
    return;
...
void EsUtilities::formPositionFix(TForm* frm)
{
  ...
  {
    const System::Types::TPoint& pnt = screenSizeGet().Round();
    rw = pnt.X;
    rh = pnt.Y;
  }
...
void EsUtilities::errorShow(const EsString& error, bool warning /*= false*/, TCustomImageList* images /*= nullptr*/, TFormPosition pos /*= TFormPosition::MainFormCenter*/)
{
  errorShow(
    EsString::null(),
    error,
...
void EsUtilities::errorShow(const EsString& caption, const EsString& error, bool warning /*= false*/, TCustomImageList* images /*= nullptr*/, TFormPosition pos /*= TFormPosition::MainFormCenter*/)
{
  messageShow(
    caption,
    error,
...
void EsUtilities::messageShow(const EsString& msg, TMsgDlgType type, TCustomImageList* images /*= nullptr*/, TDlgUserPrompt::CustomButtonCaptionGetterT customCaptionGetter /*= nullptr*/, TFormPosition pos /*= TFormPosition::MainFormCenter*/)
{
  messageShow(
    EsString::null(),
    msg,
...
void EsUtilities::messageShow(const EsString& msg, TMsgDlgType type, TMsgDlgBtn btn /*= TMsgDlgBtn::mbClose*/, TCustomImageList* images /*= nullptr*/, TDlgUserPrompt::CustomButtonCaptionGetterT customCaptionGetter /*= nullptr*/, TFormPosition pos /*= TFormPosition::MainFormCenter*/)
{
  messageShow(
    EsString::null(),
    msg,
...
void EsUtilities::messageShow(const EsString& caption, const EsString& msg, TMsgDlgType type, TCustomImageList* images /*= nullptr*/, TDlgUserPrompt::CustomButtonCaptionGetterT customCaptionGetter /*= nullptr*/, TFormPosition pos /*= TFormPosition::MainFormCenter*/)
{
...
void EsUtilities::messageShow(const EsString& caption, const EsString& msg, TMsgDlgType type, TMsgDlgBtn btn /*= TMsgDlgBtn::mbClose*/, TCustomImageList* images /*= nullptr*/, TDlgUserPrompt::CustomButtonCaptionGetterT customCaptionGetter /*= nullptr*/, TFormPosition pos /*= TFormPosition::MainFormCenter*/)
{
  TDlgUserPrompt::execute(
    Application,
    pos,
