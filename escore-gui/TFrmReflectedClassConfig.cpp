...
//---------------------------------------------------------------------------
__fastcall TFrmReflectedClassConfig::TFrmReflectedClassConfig(
  TComponent* Owner,
...
void TFrmReflectedClassConfig::i18nMgrSet(PlainEsI18nManagerPtrT mgr)
{
...
void __fastcall TFrmReflectedClassConfig::onGuiStringsUpdate(TObject* ES_UNUSED(sender))
{
  i18nStringsUpdate(
...
EsString TFrmReflectedClassConfig::supportedTypeNameGet() const
{
  ES_ASSERT(m_src);
