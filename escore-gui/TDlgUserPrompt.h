...
class DELPHICLASS TDlgUserPrompt;
...
public:
  typedef std::function<EsString(TMsgDlgBtn btn)> CustomButtonCaptionGetterT;
...
public:		// User declarations
  ...
  __property TDlgUserPrompt::CustomButtonCaptionGetterT onCustomButtonCaption = {read=m_onBtnCaptionGet,write=m_onBtnCaptionGet};

protected:
  virtual void onDlgShow();

  EsString buttonCaptionGet(TMsgDlgBtn btn) const;
...
protected:
  CustomButtonCaptionGetterT m_onBtnCaptionGet;
  float m_msgFontSize;
  TMsgDlgType m_type;
