...
private:
	...
	EsI18nManager();
	EsI18nManager(const EsI18nManager&);
	EsI18nManager& operator=(const EsI18nManager&);
...
private:
	EsI18nManagerScope();
	EsI18nManagerScope(const EsI18nManagerScope&);
	EsI18nManagerScope& operator= (const EsI18nManagerScope&);
