...
///
class DELPHICLASS EsBusyMessage;
class ESCORE_GUI_PKG EsBusyMessage : public TComponent
{
...
private:
  __weak EsBusyMessage* m_bm;
	...
	ES_NO_DEFAULT_CTR(EsBusyMessageScope);
	ES_NON_COPYABLE(EsBusyMessageScope);
};
//---------------------------------------------------------------------------
...
private:
  ...
  __weak TFmxObject* m_parent;
	...
	ES_NO_DEFAULT_CTR(EsBusyMessageTmpHideScope);
	ES_NON_COPYABLE(EsBusyMessageTmpHideScope);
};
//---------------------------------------------------------------------------
#endif
