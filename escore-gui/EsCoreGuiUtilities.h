...
#define esECCVT(x) EsVariant(x.c_str(), EsVariant::ACCEPT_STRING)
//---------------------------------------------------------------------------
...
///
ESCORE_GUI_FUNC( void, errorShow(const EsString& caption, const EsString& error, bool warning = false, TCustomImageList* images = nullptr) );
ESCORE_GUI_FUNC( void, errorShow(const EsString& error, bool warning = false, TCustomImageList* images = nullptr) );

/// User message box
ESCORE_GUI_FUNC( void, messageShow(const EsString& caption, const EsString& msg, TMsgDlgType type, TMsgDlgBtn btn = TMsgDlgBtn::mbClose, TCustomImageList* images = nullptr, TDlgUserPrompt::CustomButtonCaptionGetterT customCaptionGetter = nullptr) );
ESCORE_GUI_FUNC( void, messageShow(const EsString& caption, const EsString& msg, TMsgDlgType type, TCustomImageList* images = nullptr, TDlgUserPrompt::CustomButtonCaptionGetterT customCaptionGetter = nullptr) );
ESCORE_GUI_FUNC( void, messageShow(const EsString& msg, TMsgDlgType type, TMsgDlgBtn btn = TMsgDlgBtn::mbClose, TCustomImageList* images = nullptr, TDlgUserPrompt::CustomButtonCaptionGetterT customCaptionGetter = nullptr) );
ESCORE_GUI_FUNC( void, messageShow(const EsString& msg, TMsgDlgType type, TCustomImageList* images = nullptr, TDlgUserPrompt::CustomButtonCaptionGetterT customCaptionGetter = nullptr) );
...
/// Apply fixup to custom style from the default style.
